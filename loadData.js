$.getJSON("data.json", function(data){
  ...
  $.each(items[1], function(key,val){
    $('#standort').append('<option value="'+val+'">'+val+'</option>');
  });
  $('#cs2 .m-flex-wrap').append('<div class="m-dropdown" id="dd_standort"><label>Abteilung</label><select id="abteilung"></div>');
  $.each(items[2], function(key,val){
  ...
  $('#cs5').append('<div class="container-headline" id="cs5-headline"><h3>Gruppen</h3></div>');
