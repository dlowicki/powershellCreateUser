function loadErstellen() {
    ...
    $('#widget').append('<div class="container-small" id="cs1"></div><div class="container-small" id="cs2"></div><div class="container-small" id="cs3"></div><div class="container-small" id="cs4"></div><div class="container-small" id="cs5"></div><div class="container-small" id="cs6"></div>');
    ...
    // Lade Container 2
    $('#cs2').append('<h3>Firmen-Daten</h3>');
    $('#cs2').append('<div class="m-flex-wrap"></div>');
    $('#cs2 .m-flex-wrap').append('<div class="m-dropdown" id="dd_firma"><label>Firma</label><select id="firma"><option value="SJ">Schrauben-Jäger</option><option value="WJ">Werkzeug-Jäger</option></select></div>');
    $('#cs2 .m-flex-wrap').append('<div class="m-dropdown" id="dd_standort"><label>Standort</label><select id="standort"><option value="karlsruhe">Karlsruhe</option><option value="illingen">Illingen</option><option value="landsberg">Landsberg</option><option value="maulburg">Maulburg</option><option value="viernheim">Viernheim</option><option value="willstaett">Willstätt</option></select></div>');
    $('#cs2 .m-flex-wrap').append('<div class="m-dropdown" id="dd_standort"><label>Abteilung</label><select id="standort"><option value="karlsruhe">Karlsruhe</option><option value="illingen">Illingen</option><option value="landsberg">Landsberg</option><option value="maulburg">Maulburg</option><option value="viernheim">Viernheim</option><option value="willstaett">Willstätt</option></select></div>');

    // Lade Container 3
    $('#cs3').append('<h3>Abteilungs-Daten</h3>');
    ...
    $('#cs3 .m-flex-wrap').append('<div class="m-dropdown" id="dd_vorgesetzter"><label>Vorgesetzter</label><select id="vorgesetzter"><option value="Vorgesetzter 1">Vorgesetzter 1</option><option value="Vorgesetzter 2">Vorgesetzter 2</option><option value="Vorgesetzter 3">Vorgesetzter 3</option><option value="Vorgesetzter 4">Vorgesetzter 4</option><option value="Vorgesetzter 5">Vorgesetzter 5</option><option value="Vorgesetzter 6">Vorgesetzter 6</option></select></div>');
    

    // Lade Container 4
    $('#cs4').append('<h3>Hardware</h3>');
    $('#cs4').append('<div class="m-flex-wrap"></div>');
    $('#cs4 .m-flex-wrap').append('<div class="m-dropdown" id="dd_vorgesetzter"><label>Vorgesetzter</label><select id="vorgesetzter"><option value="Vorgesetzter 1">Vorgesetzter 1</option><option value="Vorgesetzter 2">Vorgesetzter 2</option><option value="Vorgesetzter 3">Vorgesetzter 3</option><option value="Vorgesetzter 4">Vorgesetzter 4</option><option value="Vorgesetzter 5">Vorgesetzter 5</option><option value="Vorgesetzter 6">Vorgesetzter 6</option></select></div>');
    

    // Lade Container 5
    $('#cs5').append('<h3>Gruppen</h3>');
    $('#cs5').append('<div class="m-flex-wrap"></div>');
    $('#cs5 .m-flex-wrap').append('<div class="m-checkbox" id="cb_gruppen"><div class="cb"><label>Gruppe1</label><label class="switch"><input type="checkbox" id="m_gp1"><span class="slider round"></span></label></div></div>');
    $('#cs5 .m-flex-wrap').append('<div class="m-checkbox" id="cb_gruppen"><div class="cb"><label>Gruppe2</label><label class="switch"><input type="checkbox" id="m_gp2"><span class="slider round"></span></label></div></div>');
    $('#cs5 .m-flex-wrap').append('<div class="m-checkbox" id="cb_gruppen"><div class="cb"><label>Gruppe3</label><label class="switch"><input type="checkbox" id="m_gp3"><span class="slider round"></span></label></div></div>');
    $('#cs5 .m-flex-wrap').append('<div class="m-checkbox" id="cb_gruppen"><div class="cb"><label>Gruppe1</label><label class="switch"><input type="checkbox" id="m_gp1"><span class="slider round"></span></label></div></div>');
    $('#cs5 .m-flex-wrap').append('<div class="m-checkbox" id="cb_gruppen"><div class="cb"><label>Gruppe2</label><label class="switch"><input type="checkbox" id="m_gp2"><span class="slider round"></span></label></div></div>');
    $('#cs5 .m-flex-wrap').append('<div class="m-checkbox" id="cb_gruppen"><div class="cb"><label>Gruppe3</label><label class="switch"><input type="checkbox" id="m_gp3"><span class="slider round"></span></label></div></div>');
    $('#cs5 .m-flex-wrap').append('<div class="m-checkbox" id="cb_gruppen"><div class="cb"><label>Gruppe1</label><label class="switch"><input type="checkbox" id="m_gp1"><span class="slider round"></span></label></div></div>');
